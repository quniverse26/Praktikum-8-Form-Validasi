...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (empty($_POST["nama_ibu_kandung"])) {
		$error_nama_ibu_kandung = "Nama tidak boleh kosong";
	} else {
		$nama_ibu_kandung = cek_input($_POST["nama_ibu_kandung"]);
		if (!preg_match("/^[a-zA-Z ]*$/", $nama_ibu_kandung)) {
			...
			<div class="card-body">
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" name="nama_ibu_kandung" class="form-control <?php echo ($error_nama_ibu_kandung !="" ? "is-invalid" : ""); ?>" id="nama_ibu_kandung" placeholder="Nama Ibu Kandung" value="<?php echo $nama_ibu_kandung; ?>">
							<span class="warning"><?php echo $error_nama_ibu_kandung; ?></span>
						</div>
					</div>
...
echo "Nama Ibu Kandung = ".$nama_ibu_kandung;
echo "<br>";
